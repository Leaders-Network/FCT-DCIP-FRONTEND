  ...
  return (
    <div className="w-full min-h-screen bg-[#f8f8f8] font-sans flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <aside className="w-48 bg-white pt-8 hidden md:block border-r border-gray-200">
          <nav className="space-y-4">
            <div className="h-[40px] bg-[#028835] rounded-lg flex items-center px-4 mx-4 hover:bg-[#027830] transition-colors">
              <Link className="flex gap-2 items-center w-full" href="/dashboard">
            ...
            <div className="px-4">
              <Link
                className="flex gap-2 items-center p-2 rounded-lg hover:bg-gray-100 transition-colors"
