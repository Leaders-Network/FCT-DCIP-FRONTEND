    ...
    <NotificationProvider>
      <div className="flex h-screen min-w-0 gap-0 bg-gradient-to-br from-slate-50 via-emerald-50/30 to-cyan-50/20 p-0 sm:gap-3 sm:p-4 print:block print:h-auto print:bg-white print:p-0">
        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-visible print:block print:overflow-visible print:bg-white">
          ...
          <main className="min-w-0 flex-1 overflow-auto rounded-none border border-white/70 bg-white/60 p-3 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl sm:rounded-[2rem] sm:p-4 md:p-6 print:overflow-visible print:rounded-none print:border-0 print:bg-white print:p-0 print:shadow-none">
            {children}
          </main>
        </div>
      </div>
