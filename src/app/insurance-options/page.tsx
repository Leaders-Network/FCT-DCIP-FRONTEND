...
const InsuranceOption = () => {
  const insuranceOptions = [
...

    {
      ...
      description:
        "Provides financial compensation to dependents when an employee dies, disappears, or becomes permanently disabled.",
      details: [
...

    {
      ...
      description:
        "Covers government buildings, facilities, vehicles, and employees against risks.",
      details: [
...

    {
      ...
      description:
        "Covers fire, explosion, operational hazards and liability arising from petroleum and gas operations.",
      details: [
...

    {
      ...
      description:
        "Covers patients against negligence, malpractice or medical errors by healthcare professionals.",
      details: [
...

    {
      ...
      description:
        "Covers aircraft, passengers, crew and third-party liability for aviation operations.",
      details: [
...

    {
      ...
      description:
        "Protects imported cargo against loss, damage, theft, and transit risks.",
      details: [
...

    {
      ...
      description:
        "Covers liability for death, injuries and property damage to third parties.",
      details: [
...

    {
      ...
      description:
        "Pays off borrower’s outstanding loan if they die or become permanently disabled.",
      details: [
...

    {
      ...
      description:
        "Covers container loss, damage, fire, theft and handling accidents.",
      details: [
