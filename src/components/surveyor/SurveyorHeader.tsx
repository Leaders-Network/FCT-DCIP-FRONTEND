...
const SurveyorHeader: React.FC<SurveyorHeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <header className="sticky top-3 z-30 mb-4 overflow-hidden rounded-[2rem] border border-white/70 bg-white/85 shadow-[0_18px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl print:hidden">
