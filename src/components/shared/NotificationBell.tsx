...
const NotificationBell: React.FC = () => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown */}
            {isOpen && (
                <div className="absolute right-0 mt-2 w-[min(24rem,calc(100vw-2rem))] max-w-[calc(100vw-2rem)] bg-white rounded-lg shadow-xl border border-gray-200 z-[100] max-h-[min(600px,calc(100vh-6rem))] flex flex-col">
                    {/* Header */}
