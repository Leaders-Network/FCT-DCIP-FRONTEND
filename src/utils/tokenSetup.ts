...
export const setupTestTokens = () => {
    ...
    // Valid NIA admin token from real backend
    const niaAdminToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2OTA3NzhhNTA2ZGFlZWU2NjRlNmU3NzEiLCJmdWxsbmFtZSI6Ik5JQSBBZG1pbmlzdHJhdG9yIiwic3RhdHVzIjoiQWN0aXZlIiwicm9sZSI6Ik5JQS1BZG1pbiIsIm1vZGVsIjoiRW1wbG95ZWUiLCJpYXQiOjE3NjIwOTc0ODcsImV4cCI6MTc2NDY4OTQ4N30.Rc46wIIIsVsPCfT5x-G5VLz680-opxNWioXimr-DX-c';

    // Set tokens for different admin types
    localStorage.setItem('adminToken', testToken);
    localStorage.setItem('niaAdminToken', niaAdminToken);
